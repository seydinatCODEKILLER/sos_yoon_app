...
export function LoginPage() {
  return (
    <div className="grid h-screen overflow-hidden bg-ink md:grid-cols-2">
      ...
      <div className="relative flex h-screen flex-col overflow-y-auto px-6 py-10 shadow-[inset_12px_0_24px_-20px_rgba(0,0,0,0.6)] md:overflow-hidden md:py-24">
        {/* Dégradé */}
