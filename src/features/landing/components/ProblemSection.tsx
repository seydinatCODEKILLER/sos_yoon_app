  ...
  return (
    <section className="relative overflow-hidden bg-paper py-24 md:py-32">
      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        {/* labels avant/après — visibles aussi sur mobile désormais */}
        <div className="mt-14 grid grid-cols-[1fr_auto] items-center gap-4 md:grid-cols-[1fr_3.5rem_1fr] md:gap-0">
          <p className="text-sm font-medium uppercase tracking-widest text-ink/35">
            Signal brouillé
          </p>
          <span className="hidden md:block" />
          <p className="text-right text-sm font-medium uppercase tracking-widest text-signal md:text-left">
            Avec SOS Yoon
          </p>
        </div>
            ...
            {transitions.map((t, i) => (
              <StaggerItem key={i}>
                <div className="group grid grid-cols-1 items-stretch gap-3 md:grid-cols-[1fr_3.5rem_1fr] md:gap-0">
                  ...
                  <div className="relative overflow-hidden rounded border border-ink/10 bg-ink/2 px-6 py-5 transition-opacity duration-300 md:mr-6 group-hover:opacity-50">
                    <div
                  ...
                  <div className="relative overflow-hidden rounded border border-signal/25 bg-ink px-6 py-5 text-paper transition-all duration-300 md:ml-6 group-hover:border-signal/50 group-hover:shadow-[0_20px_40px_-24px_var(--color-signal)]">
                    <motion.div
